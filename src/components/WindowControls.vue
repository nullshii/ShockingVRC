...
import CloseIcon from '@/assets/controls/close.svg?component';
import MaximizeIcon from '@/assets/controls/maximize.svg?component';
import MinimizeIcon from '@/assets/controls/minimize.svg?component';
