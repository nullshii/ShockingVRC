...
<template>
    <div
        class="flex justify-center items-center gap-2 py-1 px-2 min-w-10 border-b-2 border-separator"
    >
        <component
            v-if="isCharging"
            :is="ChargingBatteryIcon"
            class="min-w-3.5 aspect-auto text-accent"
        />
